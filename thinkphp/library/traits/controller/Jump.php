...
trait Jump
{
     ...
     * @return void
     */
    protected function success($msg = '', $url = null,$module=null, $data = '', $wait = 0, array $header = [])
    {
        $code = 1;
        if (is_numeric($msg)) {
            $code = $msg;
...
//            die($url);
     ...
     * @return void
     */
    protected function result($data, $code = 0, $msg = '', $type = '',$donreload='', array $header = [],$note='',$ex1='')
    {
        $result = [
            'code' => $code,
            'msg'  => $msg,
