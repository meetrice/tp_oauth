 ...
 * Class User
 * @title 用户接口
 * @url  http://oauth.rc3cr.com/demo/user
 * @desc  用户信息相关接口
 * @version 1.0
...
class User extends Base
{
	...
	public $restMethodList = 'login|get|post|delete';
    public $table = 'Abcd';
     ...
     * @example [{name: "p1", src: "images/p1.jpg"}, {name: "p2", src: "images/p2.jpg"}, {name: "p3", src: "images/p3.jpg"}, {name: "p4", src: "images/p4.jpg"}, {name: "p5", src: "images/p5.jpg"} ]
     */
    ...
    public static function getRules()
    {
        $rules = [
                ...
                'login'=>[
                    'aaa' => ['name' => 'aaaa', 'type' => 'int', 'require' => 'true', 'default' => '', 'desc' => '用户名', 'range' => '',]
                ],
                'get'=>[
